...
if [ ! -f "gradle/wrapper/gradle-wrapper.jar" ]; then
    ...
    # Скачиваем gradle-wrapper.jar (версия 8.5)
    curl -L https://github.com/gradle/gradle/raw/v8.5/releases/8.5/gradle-8.5/bin/gradle-wrapper.jar -o gradle/wrapper/gradle-wrapper.jar
...
if [ -f "gradlew" ]; then
    ...
    echo "✗ gradlew still not found after setup"
    exit 1
fi
